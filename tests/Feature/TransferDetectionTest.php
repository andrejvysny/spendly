...
class TransferDetectionTest extends TestCase
{
    ...
    {
        $user = User::factory()->create();
        $accountA = Account::factory()->create(['user_id' => $user->id, 'iban' => 'SK9900000000000000000002']);
        $accountB = Account::factory()->create(['user_id' => $user->id, 'iban' => 'SK9900000000000000000001']);
        ...
        Transaction::factory()->create([
            ...
            'booked_date' => $date,
            'processed_date' => $date,
            'partner' => 'Kováčová Jana',
            'description' => 'From external',
            'type' => 'DEPOSIT',
            'transfer_pair_transaction_id' => null,
            'source_iban' => 'SK9900000000000000000005',
            'target_iban' => null,
        ]);
        Transaction::factory()->create([
            'account_id' => $accountB->id,
