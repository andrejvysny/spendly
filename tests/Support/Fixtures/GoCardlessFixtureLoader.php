...
final class GoCardlessFixtureLoader
{
     ...
     */
    public static function loadRevolutTransactions(string $accountId = 'LT990000000000000001'): array
    {
     ...
     * @return array<int, array<string, mixed>>
     */
    public static function loadRevolutTransactionsUsd(string $accountId = 'LT990000000000000001'): array
    {
     ...
     * @return array<int, array<string, mixed>>
     */
    public static function loadSlspTransactions(string $accountId = 'SK9900000000000000000002'): array
    {
