...
class GocardlessMapperTest extends TestCase
{
    ...
    private function revolutAccount(): Account
    {
        ...
        $account->id = 1;
        $account->user_id = 1;
        $account->gocardless_account_id = 'LT990000000000000001';
        $account->gocardless_institution_id = 'REVOLUT_REVOGB21';
        $account->bank_name = 'Revolut';
        $account->iban = 'LT990000000000000001';
    ...
    private function slspAccount(): Account
    {
        ...
        $account->id = 2;
        $account->user_id = 1;
        $account->gocardless_account_id = 'SK9900000000000000000002';
        $account->gocardless_institution_id = 'SLSP_GIBASKBX';
        $account->bank_name = 'Slovenská sporiteľňa';
        $account->iban = 'SK9900000000000000000002';
    ...
    public function test_map_transaction_data_does_not_set_transfer_when_counterparty_iban_is_external(): void
    {
        ...
        $tx = [
            ...
            'creditorName' => 'Finax',
            'creditorAccount' => ['iban' => 'SK9900000000000000000004'],
