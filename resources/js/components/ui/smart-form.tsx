...
import { DefaultValues, FieldValues, FormProvider, SubmitHandler, useForm, UseFormProps, UseFormReturn } from 'react-hook-form';
import { z } from 'zod';

interface SmartFormProps<TFieldValues extends FieldValues, Schema extends z.ZodType<TFieldValues, z.ZodTypeDef, TFieldValues>> {
    schema: Schema;
...
export function SmartForm<TFieldValues extends FieldValues, Schema extends z.ZodType<TFieldValues, z.ZodTypeDef, TFieldValues>>({
    schema,
    defaultValues,
    onSubmit,
    onChange,
