...
class ImportFailure extends Model
{
     ...
     */
    public const string ERROR_TYPE_VALIDATION_FAILED = 'validation_failed';

    public const string ERROR_TYPE_DUPLICATE = 'duplicate';

    public const string ERROR_TYPE_PROCESSING_ERROR = 'processing_error';

    public const string ERROR_TYPE_PARSING_ERROR = 'parsing_error';
